...
export namespace CampaignService {
  export const get = async (
    params: CampaignTypes.get,
  ): Promise<{ campaign: Campaign[]; total: number }> => {
    try {
  ...
  export const create = async (params: CampaignTypes.create): Promise<Campaign> => {
    try {
  ...
  export const update = async (params: CampaignTypes.update): Promise<Campaign> => {
    try {
  ...
  export const destroy = async (params: CampaignTypes.destroy): Promise<{ message: string }> => {
    try {
